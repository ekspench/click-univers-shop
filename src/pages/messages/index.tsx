...
const navigation = [
  ...
  { name: 'History', href: '#', icon: CartIcon2, current: false },
  { name: 'Balances', href: '#', icon: CartIcon2, current: false },
  { name: 'Cards', href: '#', icon: CartIcon2, current: false },
  { name: 'Recipients', href: '#', icon: CartIcon2, current: false },
  { name: 'Reports', href: '#', icon: CartIcon2, current: false },
]
const secondaryNavigation = [
  { name: 'Settings', href: '#', icon: CartIcon2 },
  { name: 'Help', href: '#', icon: CartIcon2 },
  { name: 'Privacy', href: '#', icon: CartIcon2 },
]
const cards = [
  { name: 'Account balance', href: '#', icon: CartIcon2, amount: '$30,659.45' },
  // More items...
]
const transactions = [
  {
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-accent text-white' : 'text-cyan-100 hover:text-white hover:bg-accent-hover',
