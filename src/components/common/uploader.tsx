...
export default function Uploader({ onChange, value, multiple,preview=true,size }: any) {
    ...
    if (file.id) {
      return (
        <div
          ...
          key={idx}
        >
          <div className={`flex items-center justify-center min-w-0 w-${size} h-${size} overflow-hidden`}>
