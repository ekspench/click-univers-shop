...
export default function FilterBarLayoutTwo() {
  ...
  return (
    <div
      className={cn(
        " z-10 flex xl:hidden items-center justify-between py-3 px-5 lg:px-7 bg-light border-t border-b border-border-200",
        {
    ...
    >
      ...
      <ProductTypeMenu btnClassName="text-heading hidden transition-colors duration-200 hover:text-accent focus:text-accent" />
    </div>
  );
}
