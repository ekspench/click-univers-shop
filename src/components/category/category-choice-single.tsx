...
const CategoryChoiceSingle = ({ setValue, defaultCategory, defaultChildCategory, control }:any) => {
          ...
          <div className="flex">
            <div className="flex-1 ">
              <CategoryList
                ...
                onClick={(e: Category) => {setValue(e); setCategory(e);setShow(false)}}
              />
            </div>
...
export default CategoryChoiceSingle;
